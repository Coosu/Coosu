...
namespace Backports.System
{
    ...
    internal static partial class Number
    {
        ...
        private static uint Dragon4(ulong mantissa, int exponent, uint mantissaHighBitIdx, bool hasUnequalMargins, int cutoffNumber, bool isSignificantDigits, Span<byte> buffer, out int decimalExponent)
        {
            ...
            var digitExponent = (int)Math.Ceiling(((int)mantissaHighBitIdx + exponent) * log10V2 - 0.69);
            ...
            else if (digitExponent < 0)
            {
                ...
                BigInteger.Pow10((uint)-digitExponent, out var pow10);
            ...
            var hiBlock = scale.GetBlock((uint)(scale.GetLength() - 1));
            ...
            if (hiBlock < 8 || hiBlock > 429496729)
            {
                ...
                var hiBlockLog2 = (uint)BitOperations.Log2(hiBlock);
