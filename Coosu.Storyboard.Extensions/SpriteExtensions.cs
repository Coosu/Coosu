...
namespace Coosu.Storyboard.Extensions
{
    public static class SpriteEventExtensions
    {
        ...
        public static void MoveBy(this Sprite sprite, IEasingFunction easing, int startTime, int endTime, Vector2 point) =>
            sprite.AddEventRelative(MoreEventTypes.MoveBy, easing, startTime, endTime, point.X, point.Y);
        public static void MoveBy(this Sprite sprite, IEasingFunction easing, int startTime, int endTime, double x, double y) =>
        ...
        public static void FadeBy(this Sprite sprite, IEasingFunction easing, int startTime, int endTime, double opacity) =>
        ...
        public static void ScaleBy(this Sprite sprite, IEasingFunction easing, int startTime, int endTime, double scale) =>
        ...
        public static void RotateBy(this Sprite sprite, IEasingFunction easing, int startTime, int endTime, double rotate) =>
        ...
        public static void MoveXBy(this Sprite sprite, IEasingFunction easing, int startTime, int endTime, double x) =>
        ...
        public static void MoveYBy(this Sprite sprite, IEasingFunction easing, int startTime, int endTime, double y) =>
        ...
        public static void ColorBy(this Sprite sprite, IEasingFunction easing, int startTime, int endTime, Vector3 color) =>
            sprite.AddEventRelative(MoreEventTypes.ColorBy, easing, startTime, endTime, color.X, color.Y, color.Z);
        public static void ColorBy(this Sprite sprite, IEasingFunction easing, int startTime, int endTime, byte r, byte g, byte b) =>
        ...
        public static void VectorBy(this Sprite sprite, IEasingFunction easing, int startTime, int endTime, Vector2 vector) =>
            sprite.AddEventRelative(MoreEventTypes.VectorBy, easing, startTime, endTime, vector.X, vector.Y);
        public static void VectorBy(this Sprite sprite, IEasingFunction easing, int startTime, int endTime, double x, double y) =>
