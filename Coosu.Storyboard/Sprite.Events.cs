...
namespace Coosu.Storyboard
{
    public static class SpriteBasicEventExtensions
    {
        ...
        public static void Move(this IEventHost host, double startTime, double endTime, Vector2 startPoint, Vector2 endPoint) =>
        ...
        public static void Move(this IEventHost host, EasingFunctionBase easing, double startTime, double endTime, Vector2 startPoint, Vector2 endPoint) =>
        ...
        public static void Color(this IEventHost host, double startTime, Vector3 color) =>
        ...
        /// <param name="endTime"></param>
        /// <param name="color">Fixed rgb value. The range of each value is 0-255.</param>
        public static void Color(this IEventHost host, double startTime, double endTime, Vector3 color) =>
        ...
        public static void Color(this IEventHost host, double startTime, double endTime, Vector3 color1, Vector3 color2) =>
        ...
        /// <param name="color1">Start rgb value. The range of each value is 0-255.</param>
        /// <param name="color2">End rgb value. The range of each value is 0-255.</param>
        public static void Color(this IEventHost host, EasingFunctionBase easing, double startTime, double endTime, Vector3 color1, Vector3 color2) =>
        ...
        // Vector
        public static void Vector(this IEventHost host, double startTime, Vector2 vector) =>
        ...
        public static void Vector(this IEventHost host, double startTime, double endTime, Vector2 startZoom, Vector2 endZoom) =>
        ...
        public static void Vector(this IEventHost host, EasingFunctionBase easing, double startTime, double endTime, Vector2 startZoom, Vector2 endZoom) =>
